...
% TODO: add LTE here and in the text
% TODO: add 5G here and in the text
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    \pie[sum=auto, after number={\space M}, radius=1.7, text=legend, color={orange, yellow}]{77.5/SIM-cards with LTE capabilities (44.67 \%), 93.5/SIM-cards without LTE capabilities (55.33 \%)}
  \end{tikzpicture}
